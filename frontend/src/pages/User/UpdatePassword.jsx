        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 flex items-center justify-center p-4">
          <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-green-500 to-blue-600 p-6 text-center relative overflow-hidden">
              ...
              <form className="p-6 space-y-5" onSubmit={updatePasswordSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full py-3 px-4 bg-gradient-to-r from-green-600 cursor-pointer to-blue-600 hover:from-green-700 hover:to-blue-700 text-white font-medium rounded-lg shadow-md transition-all duration-300 mt-4"
                >
                  Update Password
                </button>
              </form>

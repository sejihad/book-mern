              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <form className="p-6 space-y-5" onSubmit={updateProfileSubmit}>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full py-3 px-4 bg-gradient-to-r from-green-600 to-blue-600 cursor-pointer hover:from-green-700 hover:to-blue-700 text-white font-medium rounded-lg shadow-md transition-all duration-300 ${
